...
#path_directory_source="${path_directory_scripts}/age_exercise/record_analyses/2025-05-13_table_1_2"
...
path_file_product="${path_directory_product}/table_parameters_regression_automatic_age_ols.tsv"
...
selection_observations="age_cohort_text:younger,elder;sex_text:female,male;visit_text:first"
type_regression="continuous_ols"
formula_text="response ~ age_cohort_elder + sex_male"
#feature_response="${response}" # this parameter varies
features_predictor_fixed="age_cohort_elder,sex_male"
