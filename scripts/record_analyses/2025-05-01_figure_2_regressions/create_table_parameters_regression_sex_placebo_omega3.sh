...
formula_text="response ~ sex_female_intervention_after_omega3 + sex_female + intervention_after_omega3 + intervention_after_placebo + identifier_subject"
#feature_response="${response}" # this parameter varies
features_predictor_fixed="sex_female_intervention_after_omega3,sex_female,intervention_after_omega3,intervention_after_placebo"
