...
#path_file_table_parameters="${path_directory_parameters_private}/age_exercise/regression/table_parameters_regression_automatic_placebo_omega3.tsv"
#path_file_table_parameters="${path_directory_parameters_private}/age_exercise/regression/table_parameters_regression_automatic_placebo_omega3_female.tsv"
path_file_table_parameters="${path_directory_parameters_private}/age_exercise/regression/table_parameters_regression_automatic_placebo_omega3_male.tsv"
#path_file_table_parameters="${path_directory_parameters_private}/age_exercise/regression/table_parameters_regression_automatic_interaction_sex_omega3.tsv"
